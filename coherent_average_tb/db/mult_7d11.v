...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=33 dataa datab result
...
module  mult_7d11
	...
	wire	[47:0]	wire_add2_result;
	wire	[19:0]	wire_add22_result;
	wire	[42:0]	wire_add7_result;
	...
	wire  [42:0]   wire_sft10a_in;
	wire  [42:0]   wire_sft10a_out;
	wire  [42:0]   wire_sft11a_in;
	wire  [42:0]   wire_sft11a_out;
	...
	wire  [19:0]   wire_sft23a_in;
	wire  [19:0]   wire_sft23a_out;
	wire  [19:0]   wire_sft24a_in;
	wire  [19:0]   wire_sft24a_out;
	wire  [19:0]   wire_sft25a_in;
	wire  [19:0]   wire_sft25a_out;
	wire  [19:0]   wire_sft26a_in;
	wire  [19:0]   wire_sft26a_out;
	wire  [47:0]   wire_sft3a_in;
	wire  [47:0]   wire_sft3a_out;
	wire  [47:0]   wire_sft4a_in;
	wire  [47:0]   wire_sft4a_out;
	wire  [47:0]   wire_sft5a_in;
	wire  [47:0]   wire_sft5a_out;
	wire  [47:0]   wire_sft6a_in;
	wire  [47:0]   wire_sft6a_out;
	wire  [42:0]   wire_sft8a_in;
	wire  [42:0]   wire_sft8a_out;
	wire  [42:0]   wire_sft9a_in;
	wire  [42:0]   wire_sft9a_out;
	wire  [31:0]  dataa_node;
	wire  [16:0]  datab_node;
	wire  [48:0]  final_result_node;
	wire  [49:0]  w1380w;
	wire  w664w;
	wire  w700w;
	wire  [543:0]  w_decoder_node9w;
	wire  [16:0]  w_le_datab_node8w;
	wire  [31:0]  w_lone_sum_node11w;
	wire  [271:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w700w, {w700w, {w700w, {w700w, {w700w, {(~ w_sum_node10w[203]), {w664w, {(~ w_lone_sum_node11w[25]), {(~ w_lone_sum_node11w[24]), {w_sum_node10w[263], {w_sum_node10w[262], {w_sum_node10w[229], {w_sum_node10w[228], {wire_sft26a_out[19], {wire_sft26a_out[18], {wire_sft26a_out[17], {wire_sft26a_out[16], {wire_sft26a_out[15], {wire_sft26a_out[14], {wire_sft26a_out[13], {wire_sft26a_out[12], {wire_sft26a_out[11], {wire_sft26a_out[10], {wire_sft26a_out[9], {wire_sft26a_out[8], {wire_sft26a_out[7], {wire_sft26a_out[6], {wire_sft26a_out[5], {wire_sft26a_out[4], {wire_sft26a_out[3], {wire_sft26a_out[2], {wire_sft26a_out[1], {wire_sft26a_out[0], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {2{w700w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft14a_in = {w700w, {w700w, {w700w, {w_sum_node10w[200], {w_sum_node10w[167], {w_sum_node10w[166], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft23a_in = {w700w, {w_sum_node10w[162], {w664w, {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[113], w664w}}}}}}}}}}}}}}}}}}};
	soft   sft24a_0
	( 
	...
	assign
		wire_sft24a_in = {w700w, {w700w, {w_sum_node10w[161], {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, w_sum_node10w[144]}}}}}}}}}}}}}}}}}}};
	soft   sft25a_0
	( 
	...
	assign
		wire_sft25a_in = {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {w700w, {2{w700w}}}}}}}}}}}}}}}}}}}};
	soft   sft26a_0
	( 
	...
	assign
		wire_sft3a_in = {w664w, {wire_sft11a_out[42], {w664w, {w664w, {(~ w_lone_sum_node11w[29]), {w_sum_node10w[236], {w_sum_node10w[235], {w_sum_node10w[234], {w_sum_node10w[201], {w_sum_node10w[168], {wire_sft11a_out[33], {wire_sft11a_out[32], {wire_sft11a_out[31], {wire_sft11a_out[30], {wire_sft11a_out[29], {wire_sft11a_out[28], {wire_sft11a_out[27], {wire_sft11a_out[26], {wire_sft11a_out[25], {wire_sft11a_out[24], {wire_sft11a_out[23], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft8a_in = {w700w, {(~ w_sum_node10w[271]), {w_sum_node10w[270], {(~ w_sum_node10w[237]), {w664w, {(~ w_lone_sum_node11w[27]), {(~ w_lone_sum_node11w[26]), {w_sum_node10w[265], {w_sum_node10w[264], {w_sum_node10w[231], {w_sum_node10w[230], {w_sum_node10w[197], {w_sum_node10w[196], {w_sum_node10w[195], {w_sum_node10w[194], {w_sum_node10w[129], {w_sum_node10w[160], {w_sum_node10w[159], {w_sum_node10w[158], {w_sum_node10w[157], {w_sum_node10w[156], {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[149], {w_sum_node10w[148], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[145], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103:102]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w700w, {w700w, {w700w, {w700w, {(~ w_lone_sum_node11w[28]), {w_sum_node10w[267], {w_sum_node10w[266], {w_sum_node10w[233], {w_sum_node10w[232], {w_sum_node10w[199], {w_sum_node10w[198], {w_sum_node10w[165], {w_sum_node10w[164], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71:70]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[31:0]},
		datab_node = {datab[16:0]},
		final_result_node = {w1380w[48:0]},
		result = {final_result_node[48:0]},
		w1380w = {wire_sft6a_out[47:46], wire_sft6a_out[45:44], wire_sft6a_out[43:42], wire_sft6a_out[41:40], wire_sft6a_out[39:38], wire_sft6a_out[37:36], wire_sft6a_out[35:34], wire_sft6a_out[33:32], wire_sft6a_out[31:30], wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w664w = 1'b1,
		w700w = 1'b0,
		w_decoder_node9w = {({dataa_node[31:0]} & {32{w_le_datab_node8w[16]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[15]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[14]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[13]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[12]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[11]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[10]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[9]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[8]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[7]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[6]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[5]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[4]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[3]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[2]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[1]}}), ({dataa_node[31:0]} & {32{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[16:0]},
		w_lone_sum_node11w = {w_decoder_node9w[543:512]},
		w_sum_node10w = {wire_sum_adder1aa_7result[32:0], w_decoder_node9w[448], wire_sum_adder1aa_6result[32:0], w_decoder_node9w[384], wire_sum_adder1aa_5result[32:0], w_decoder_node9w[320], wire_sum_adder1aa_4result[32:0], w_decoder_node9w[256], wire_sum_adder1aa_3result[32:0], w_decoder_node9w[192], wire_sum_adder1aa_2result[32:0], w_decoder_node9w[128], wire_sum_adder1aa_1result[32:0], w_decoder_node9w[64], wire_sum_adder1aa_0result[32:0], w_decoder_node9w[0]};
endmodule //mult_7d11
//VALID FILE
