...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=13 dataa datab result
...
module  mult_rj11
	...
	wire  [6:0]   wire_sft13a_in;
	wire  [6:0]   wire_sft13a_out;
	wire  [6:0]   wire_sft14a_in;
	wire  [6:0]   wire_sft14a_out;
	wire  [6:0]   wire_sft15a_in;
	wire  [6:0]   wire_sft15a_out;
	wire  [6:0]   wire_sft16a_in;
	wire  [6:0]   wire_sft16a_out;
	...
	assign
		wire_sum_adder1aa_0dataa = {1'b0, w_decoder_node9w[23:12]},
		wire_sum_adder1aa_0datab = {{2{1'b0}}, w_decoder_node9w[11:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {1'b0, w_decoder_node9w[47:36]},
		wire_sum_adder1aa_1datab = {{2{1'b0}}, w_decoder_node9w[35:25]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[71:60]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[59:49]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[95:84]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[83:73]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {1'b0, w_decoder_node9w[119:108]},
		wire_sum_adder1aa_4datab = {{2{1'b0}}, w_decoder_node9w[107:97]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {1'b0, w_decoder_node9w[143:132]},
		wire_sum_adder1aa_5datab = {{2{1'b0}}, w_decoder_node9w[131:121]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w274w, {w274w, {w274w, {w274w, {w_sum_node10w[40], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {2{w274w}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w274w, {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71:70]}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w274w, {w274w, {w274w, {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23:22]}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w274w, {w274w, {w274w, {w274w, {w274w, {2{w274w}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w274w, {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[41], {w_sum_node10w[52], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w274w, {w274w, {w274w, {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[53], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w274w, {w274w, {w274w, {w274w, {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[29], {w_sum_node10w[28], {2{w274w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w274w, {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w274w, {w274w, {w274w, {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31:30]}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[11:0]},
		datab_node = {datab[11:0]},
		final_result_node = {w454w[23:0]},
		result = {final_result_node[23:0]},
		w274w = 1'b0,
		w454w = {wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
