...
module  mult_3k11
	...
	wire	[14:0]	wire_sum_adder1aa_6dataa;
	wire	[14:0]	wire_sum_adder1aa_6datab;
	wire	[14:0]	wire_sum_adder1aa_6result;
	wire  [18:0]   wire_sft10a_in;
	wire  [18:0]   wire_sft10a_out;
	wire  [18:0]   wire_sft11a_in;
	wire  [18:0]   wire_sft11a_out;
	wire  [10:0]   wire_sft13a_in;
	wire  [10:0]   wire_sft13a_out;
	wire  [10:0]   wire_sft14a_in;
	wire  [10:0]   wire_sft14a_out;
	wire  [10:0]   wire_sft15a_in;
	wire  [10:0]   wire_sft15a_out;
	wire  [10:0]   wire_sft16a_in;
	wire  [10:0]   wire_sft16a_out;
	...
	assign
		wire_sum_adder1aa_6dataa = {1'b0, w_decoder_node9w[195:182]},
		wire_sum_adder1aa_6datab = {{2{1'b0}}, w_decoder_node9w[181:169]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w335w, {w335w, {w335w, {w335w, {w_sum_node10w[62], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {2{w335w}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w335w, {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81:80]}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w335w, {w335w, {w335w, {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25:24]}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w335w, {w335w, {w335w, {w335w, {w335w, {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {2{w335w}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w335w, {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[63], {w_sum_node10w[76], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w335w, {w335w, {w335w, {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[77], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17:16]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w335w, {w335w, {w335w, {w335w, {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[33], {w_sum_node10w[32], {2{w335w}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w335w, {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
