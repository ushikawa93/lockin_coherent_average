...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=31 dataa datab result
...
module  mult_4k11
	...
	wire	[26:0]	wire_add12_result;
	wire	[42:0]	wire_add2_result;
	wire	[34:0]	wire_add7_result;
	wire	[30:0]	wire_sum_adder1aa_0dataa;
	wire	[30:0]	wire_sum_adder1aa_0datab;
	wire	[30:0]	wire_sum_adder1aa_0result;
	wire	[30:0]	wire_sum_adder1aa_1dataa;
	wire	[30:0]	wire_sum_adder1aa_1datab;
	wire	[30:0]	wire_sum_adder1aa_1result;
	wire	[30:0]	wire_sum_adder1aa_2dataa;
	wire	[30:0]	wire_sum_adder1aa_2datab;
	wire	[30:0]	wire_sum_adder1aa_2result;
	wire	[30:0]	wire_sum_adder1aa_3dataa;
	wire	[30:0]	wire_sum_adder1aa_3datab;
	wire	[30:0]	wire_sum_adder1aa_3result;
	wire	[30:0]	wire_sum_adder1aa_4dataa;
	wire	[30:0]	wire_sum_adder1aa_4datab;
	wire	[30:0]	wire_sum_adder1aa_4result;
	wire	[30:0]	wire_sum_adder1aa_5dataa;
	wire	[30:0]	wire_sum_adder1aa_5datab;
	wire	[30:0]	wire_sum_adder1aa_5result;
	wire	[30:0]	wire_sum_adder1aa_6dataa;
	wire	[30:0]	wire_sum_adder1aa_6datab;
	wire	[30:0]	wire_sum_adder1aa_6result;
	wire  [34:0]   wire_sft10a_in;
	wire  [34:0]   wire_sft10a_out;
	wire  [34:0]   wire_sft11a_in;
	wire  [34:0]   wire_sft11a_out;
	wire  [26:0]   wire_sft13a_in;
	wire  [26:0]   wire_sft13a_out;
	wire  [26:0]   wire_sft14a_in;
	wire  [26:0]   wire_sft14a_out;
	wire  [26:0]   wire_sft15a_in;
	wire  [26:0]   wire_sft15a_out;
	wire  [26:0]   wire_sft16a_in;
	wire  [26:0]   wire_sft16a_out;
	...
	assign
		wire_sum_adder1aa_0dataa = {1'b0, w_decoder_node9w[59:30]},
		wire_sum_adder1aa_0datab = {{2{1'b0}}, w_decoder_node9w[29:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {1'b0, w_decoder_node9w[119:90]},
		wire_sum_adder1aa_1datab = {{2{1'b0}}, w_decoder_node9w[89:61]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[179:150]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[149:121]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[239:210]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[209:181]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {1'b0, w_decoder_node9w[299:270]},
		wire_sum_adder1aa_4datab = {{2{1'b0}}, w_decoder_node9w[269:241]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {1'b0, w_decoder_node9w[359:330]},
		wire_sum_adder1aa_5datab = {{2{1'b0}}, w_decoder_node9w[329:301]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {1'b0, w_decoder_node9w[419:390]},
		wire_sum_adder1aa_6datab = {{2{1'b0}}, w_decoder_node9w[389:361]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w495w, {w495w, {w495w, {w495w, {w_sum_node10w[126], {w_sum_node10w[215], {w_sum_node10w[214], {w_sum_node10w[183], {w_sum_node10w[182], {w_sum_node10w[151], {w_sum_node10w[150], {w_sum_node10w[149], {w_sum_node10w[148], {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134], {w_sum_node10w[133], {w_sum_node10w[132], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[129], {w_sum_node10w[128], {2{w495w}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w495w, {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[213], {w_sum_node10w[212], {w_sum_node10w[181], {w_sum_node10w[180], {w_sum_node10w[179], {w_sum_node10w[178], {w_sum_node10w[177], {w_sum_node10w[176], {w_sum_node10w[175], {w_sum_node10w[174], {w_sum_node10w[173], {w_sum_node10w[172], {w_sum_node10w[171], {w_sum_node10w[170], {w_sum_node10w[169], {w_sum_node10w[168], {w_sum_node10w[167], {w_sum_node10w[166], {w_sum_node10w[165], {w_sum_node10w[164], {w_sum_node10w[163], {w_sum_node10w[162], {w_sum_node10w[161:160]}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft4a_in = {w495w, {w495w, {w495w, {w_sum_node10w[221], {w_sum_node10w[220], {w_sum_node10w[189], {w_sum_node10w[188], {w_sum_node10w[157], {wire_sft11a_out[30], {wire_sft11a_out[29], {wire_sft11a_out[28], {wire_sft11a_out[27], {wire_sft11a_out[26], {wire_sft11a_out[25], {wire_sft11a_out[24], {wire_sft11a_out[23], {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33:32]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft8a_in = {w495w, {w_sum_node10w[159], {w_sum_node10w[158], {w_sum_node10w[217], {w_sum_node10w[216], {w_sum_node10w[185], {w_sum_node10w[184], {w_sum_node10w[153], {w_sum_node10w[152], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97:96]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w495w, {w495w, {w495w, {w_sum_node10w[187], {w_sum_node10w[186], {w_sum_node10w[155], {w_sum_node10w[154], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67:66]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[29:0]},
		datab_node = {dataa[13:0]},
		final_result_node = {w915w[43:0]},
		result = {final_result_node[43:0]},
		w495w = 1'b0,
		w915w = {wire_sft6a_out[42:41], wire_sft6a_out[40:39], wire_sft6a_out[38:37], wire_sft6a_out[36:35], wire_sft6a_out[34:33], wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[29:0]} & {30{w_le_datab_node8w[13]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[12]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[11]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[10]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[9]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[8]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[7]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[6]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[5]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[4]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[3]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[2]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[1]}}), ({dataa_node[29:0]} & {30{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[13:0]},
		w_sum_node10w = {wire_sum_adder1aa_6result[30:0], w_decoder_node9w[360], wire_sum_adder1aa_5result[30:0], w_decoder_node9w[300], wire_sum_adder1aa_4result[30:0], w_decoder_node9w[240], wire_sum_adder1aa_3result[30:0], w_decoder_node9w[180], wire_sum_adder1aa_2result[30:0], w_decoder_node9w[120], wire_sum_adder1aa_1result[30:0], w_decoder_node9w[60], wire_sum_adder1aa_0result[30:0], w_decoder_node9w[0]};
endmodule //mult_4k11
//VALID FILE
