...
//lpm_add_sub CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48 CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Cyclone V" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=18 dataa datab result
...
module  mult_6k11
	...
	wire	[17:0]	wire_add12_result;
	wire	[9:0]	wire_add17_result;
	...
	wire	[17:0]	wire_sum_adder1aa_5dataa;
	wire	[17:0]	wire_sum_adder1aa_5datab;
	wire	[17:0]	wire_sum_adder1aa_5result;
	wire	[17:0]	wire_sum_adder1aa_6dataa;
	wire	[17:0]	wire_sum_adder1aa_6datab;
	wire	[17:0]	wire_sum_adder1aa_6result;
	wire	[17:0]	wire_sum_adder1aa_7dataa;
	wire	[17:0]	wire_sum_adder1aa_7datab;
	wire	[17:0]	wire_sum_adder1aa_7result;
	wire  [25:0]   wire_sft10a_in;
	wire  [25:0]   wire_sft10a_out;
	wire  [25:0]   wire_sft11a_in;
	wire  [25:0]   wire_sft11a_out;
	wire  [17:0]   wire_sft13a_in;
	wire  [17:0]   wire_sft13a_out;
	wire  [17:0]   wire_sft14a_in;
	wire  [17:0]   wire_sft14a_out;
	wire  [17:0]   wire_sft15a_in;
	wire  [17:0]   wire_sft15a_out;
	wire  [17:0]   wire_sft16a_in;
	wire  [17:0]   wire_sft16a_out;
	wire  [9:0]   wire_sft18a_in;
	wire  [9:0]   wire_sft18a_out;
	wire  [9:0]   wire_sft19a_in;
	wire  [9:0]   wire_sft19a_out;
	wire  [9:0]   wire_sft20a_in;
	wire  [9:0]   wire_sft20a_out;
	wire  [9:0]   wire_sft21a_in;
	wire  [9:0]   wire_sft21a_out;
	...
	wire  w449w;
	wire  [34:0]  w796w;
	wire  [288:0]  w_decoder_node9w;
	wire  [16:0]  w_le_datab_node8w;
	wire  [16:0]  w_lone_sum_node11w;
	wire  [151:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_0dataa = {1'b0, w_decoder_node9w[33:17]},
		wire_sum_adder1aa_0datab = {{2{1'b0}}, w_decoder_node9w[16:1]};
	assign
		wire_sum_adder1aa_1result = wire_sum_adder1aa_1dataa + wire_sum_adder1aa_1datab;
	assign
		wire_sum_adder1aa_1dataa = {1'b0, w_decoder_node9w[67:51]},
		wire_sum_adder1aa_1datab = {{2{1'b0}}, w_decoder_node9w[50:35]};
	assign
		wire_sum_adder1aa_2result = wire_sum_adder1aa_2dataa + wire_sum_adder1aa_2datab;
	assign
		wire_sum_adder1aa_2dataa = {1'b0, w_decoder_node9w[101:85]},
		wire_sum_adder1aa_2datab = {{2{1'b0}}, w_decoder_node9w[84:69]};
	assign
		wire_sum_adder1aa_3result = wire_sum_adder1aa_3dataa + wire_sum_adder1aa_3datab;
	assign
		wire_sum_adder1aa_3dataa = {1'b0, w_decoder_node9w[135:119]},
		wire_sum_adder1aa_3datab = {{2{1'b0}}, w_decoder_node9w[118:103]};
	assign
		wire_sum_adder1aa_4result = wire_sum_adder1aa_4dataa + wire_sum_adder1aa_4datab;
	assign
		wire_sum_adder1aa_4dataa = {1'b0, w_decoder_node9w[169:153]},
		wire_sum_adder1aa_4datab = {{2{1'b0}}, w_decoder_node9w[152:137]};
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5dataa + wire_sum_adder1aa_5datab;
	assign
		wire_sum_adder1aa_5dataa = {1'b0, w_decoder_node9w[203:187]},
		wire_sum_adder1aa_5datab = {{2{1'b0}}, w_decoder_node9w[186:171]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {1'b0, w_decoder_node9w[237:221]},
		wire_sum_adder1aa_6datab = {{2{1'b0}}, w_decoder_node9w[220:205]};
	assign
		wire_sum_adder1aa_7result = wire_sum_adder1aa_7dataa + wire_sum_adder1aa_7datab;
	assign
		wire_sum_adder1aa_7dataa = {1'b0, w_decoder_node9w[271:255]},
		wire_sum_adder1aa_7datab = {{2{1'b0}}, w_decoder_node9w[254:239]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w449w, {w449w, {w449w, {w449w, {w_sum_node10w[112], {w_lone_sum_node11w[10], {w_lone_sum_node11w[9], {w_sum_node10w[143], {w_sum_node10w[142], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {2{w449w}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w449w, {w_sum_node10w[94], {w_sum_node10w[93], {w_lone_sum_node11w[8], {w_lone_sum_node11w[7], {w_sum_node10w[141], {w_sum_node10w[140], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96:95]}}}}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w449w, {w449w, {w449w, {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28:27]}}}}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w449w, {w449w, {w449w, {w449w, {w_sum_node10w[74], {w_lone_sum_node11w[6], {w_lone_sum_node11w[5], {w_sum_node10w[139], {w_sum_node10w[138], {w_sum_node10w[120], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[115], {w_sum_node10w[114], {2{w449w}}}}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w449w, {w_sum_node10w[56], {w_sum_node10w[55], {w_lone_sum_node11w[4], {w_lone_sum_node11w[3], {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[135], {w_sum_node10w[134:133]}}}}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w449w, {w449w, {w449w, {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[18], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15:14]}}}}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w449w, {w449w, {w449w, {w449w, {w449w, {w_lone_sum_node11w[2], {w_lone_sum_node11w[1], {w_lone_sum_node11w[0], {2{w449w}}}}}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft4a_in = {w449w, {w449w, {w_lone_sum_node11w[16], {w_lone_sum_node11w[15], {w_sum_node10w[149], {w_sum_node10w[148], {w_sum_node10w[130], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft11a_out[18], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20:19]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft8a_in = {w449w, {w_sum_node10w[132], {w_sum_node10w[131], {w_lone_sum_node11w[12], {w_lone_sum_node11w[11], {w_sum_node10w[145], {w_sum_node10w[144], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58:57]}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w449w, {w449w, {w449w, {w_sum_node10w[147], {w_sum_node10w[146], {w_sum_node10w[128], {w_sum_node10w[127], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41:40]}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[16:0]},
		datab_node = {datab[16:0]},
		final_result_node = {w796w[33:0]},
		result = {final_result_node[33:0]},
		w449w = 1'b0,
		w796w = {wire_sft6a_out[32:31], wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[16:0]} & {17{w_le_datab_node8w[16]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[15]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[14]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[13]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[12]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[11]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[10]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[9]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[8]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[7]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[6]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[5]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[4]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[3]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[2]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[1]}}), ({dataa_node[16:0]} & {17{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[16:0]},
		w_lone_sum_node11w = {w_decoder_node9w[288:272]},
		w_sum_node10w = {wire_sum_adder1aa_7result[17:0], w_decoder_node9w[238], wire_sum_adder1aa_6result[17:0], w_decoder_node9w[204], wire_sum_adder1aa_5result[17:0], w_decoder_node9w[170], wire_sum_adder1aa_4result[17:0], w_decoder_node9w[136], wire_sum_adder1aa_3result[17:0], w_decoder_node9w[102], wire_sum_adder1aa_2result[17:0], w_decoder_node9w[68], wire_sum_adder1aa_1result[17:0], w_decoder_node9w[34], wire_sum_adder1aa_0result[17:0], w_decoder_node9w[0]};
endmodule //mult_6k11
//VALID FILE
