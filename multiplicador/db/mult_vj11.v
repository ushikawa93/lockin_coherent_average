...
module  mult_vj11
	...
	wire	[12:0]	wire_add12_result;
	wire	[28:0]	wire_add2_result;
	wire	[20:0]	wire_add7_result;
	...
	wire  [20:0]   wire_sft10a_in;
	wire  [20:0]   wire_sft10a_out;
	wire  [20:0]   wire_sft11a_in;
	wire  [20:0]   wire_sft11a_out;
	wire  [12:0]   wire_sft13a_in;
	wire  [12:0]   wire_sft13a_out;
	wire  [12:0]   wire_sft14a_in;
	wire  [12:0]   wire_sft14a_out;
	wire  [12:0]   wire_sft15a_in;
	wire  [12:0]   wire_sft15a_out;
	wire  [12:0]   wire_sft16a_in;
	wire  [12:0]   wire_sft16a_out;
	...
	wire  [20:0]   wire_sft8a_in;
	wire  [20:0]   wire_sft8a_out;
	wire  [20:0]   wire_sft9a_in;
	wire  [20:0]   wire_sft9a_out;
	wire  [15:0]  dataa_node;
	wire  [13:0]  datab_node;
	wire  [29:0]  final_result_node;
	wire  w355w;
	wire  [30:0]  w607w;
	wire  [223:0]  w_decoder_node9w;
	wire  [13:0]  w_le_datab_node8w;
	wire  [125:0]  w_sum_node10w;
	...
	assign
		wire_sft10a_in = {w355w, {w355w, {w355w, {w355w, {w_sum_node10w[70], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {2{w355w}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w355w, {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91:90]}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w355w, {w355w, {w355w, {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27:26]}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w355w, {w355w, {w355w, {w355w, {w355w, {w_sum_node10w[113], {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[108], {2{w355w}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w355w, {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[121], {w_sum_node10w[120], {w_sum_node10w[71], {w_sum_node10w[86], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[17], {w_sum_node10w[16], {w_sum_node10w[15], {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w355w, {w355w, {w355w, {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[87], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19:18]}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft8a_in = {w355w, {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[119], {w_sum_node10w[118], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55:54]}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
